...
contextBridge.exposeInMainWorld("electron", {
  ...
  getVMBackend: (forceRefresh?: boolean) =>
    ipcRenderer.invoke("getVMBackend", forceRefresh) as Promise<string>,
  enableWindowsSandbox: () =>
    ipcRenderer.invoke("enableWindowsSandbox") as Promise<{
      success: boolean;
      requiresRestart: boolean;
      error?: string;
    }>,
  completeVMSetup: (options?: { skipVM?: boolean; vmName?: string }) =>
    ipcRenderer.invoke("completeVMSetup", options) as Promise<void>,
  openClassicsGame: (
    shop: GameShop,
    objectId: string,
    discPath?: string,
